<entries-batchedit>
    ...
    <div ref="modal" class="uk-modal">
        ...
        <div class="uk-modal-dialog uk-modal-dialog-large uk-form">
            ...
            <div class="uk-margin-top uk-overflow-container uk-panel-space" if="{entries.length}">
                ...
                <div class="field-container uk-panel uk-margin {checked[field.name] && 'uk-panel-box uk-panel-card'}" each="{field in _fields}" if={ isFieldEditable(field) }>
                    <div class="uk-grid">
    ...
    <script>
        ...
        this.isFieldEditable = function(field){
            if(typeof field === 'undefined' || typeof field.options === 'undefined' || typeof field.options.readonly === 'undefined'){
                return true;
            }
            return !field.options.readonly;
        }
